        ...
        <div className="max-w-6xl mx-auto px-6 py-12">
          ...
          <header className="text-center mb-16">
            <div className="mb-8">
              ...
              <div className="mb-6">
                <p className="text-2xl font-medium text-cyan-300 mb-2 drop-shadow-md">
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {/* Recording Features */}
              <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow hover:bg-white/95">
          ...
          {/* Quick Start Guide */}
          <section className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-gray-100">
